...
public class GivingTest extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_giving_history_test);
...
/*                    if(jarray.getJSONObject(0).getString("name") != null) {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if(error.networkResponse.statusCode==403){
                    Methods.longToast("Access Denied", GivingTest.this);
                }
                else
                    Methods.longToast("Some Error Occured,please try again later", GivingTest.this);
