...
public class CellLeaderMsg extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(NetworkHelper.isOnline(CellLeaderMsg.this)){
            Methods.showProgressDialog(CellLeaderMsg.this);
            sendCellLeaderMsg();
        }
        else
            Methods.longToast("Please connect to Internet", CellLeaderMsg.this);
            }
    ...
    private void sendCellLeaderMsg() {
        ...
        StringRequest sendCellLeaderMsg=new StringRequest(Request.Method.POST, SynergyValues.Web.SendCellLeaderMsg.SERVICE_URL,new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                Log.d("Nonstop", "send cell leader message  ---------------" + response);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if(error.networkResponse.statusCode==403){
                    Methods.longToast("Access Denied", CellLeaderMsg.this);
                }
                else
                    Methods.longToast("Some Error Occured,please try again later", CellLeaderMsg.this);
