...
public class MyTaskAdapter1 extends ArrayAdapter<Message> {

	private Context mContext;
	private ArrayList<Message> taskList;

	public MyTaskAdapter1(Context context, int resource, List<Message> objects) {
...
//			holder.chkTask = (CheckBox) convertView.findViewById(R.id.chktodo);
		...
		holder.lblTaskassignee.setText(getItem(position).get_assign());
