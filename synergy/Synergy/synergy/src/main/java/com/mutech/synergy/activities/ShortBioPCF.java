...
public class ShortBioPCF extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_short_bio_pcf);

        getSupportActionBar().setTitle("PCF Profile");
        ...
        StringRequest reqgetCellDetails=new StringRequest(Request.Method.POST, SynergyValues.Web.GetCellDetailsService.SERVICE_URL,new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Log.d("NonStop", "Sr Cell Name: " + jarray.getJSONObject(0).getString("pcf_name"));
                   Log.d("NonStop", "Sr Cell Leader: " + jarray.getJSONObject(0).getString("pcf_leader"));
                    ...
                    if(jarray.getJSONObject(0).getString("pcf_name") != null)
                        txtCellName.setText(jarray.getJSONObject(0).getString("pcf_name"));

                    if(jarray.getJSONObject(0).getString("pcf_leader") != null)
                        txtCellLeader.setText(jarray.getJSONObject(0).getString("pcf_leader"));
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if(error.networkResponse.statusCode==403){
                    Methods.longToast("Access Denied", ShortBioPCF.this);
                }
                else
                    Methods.longToast("Some Error Occured,please try again later", ShortBioPCF.this);
