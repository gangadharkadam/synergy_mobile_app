...
public class ShortBioSrCell extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_short_bio_sr_cell);

        getSupportActionBar().setTitle("Sr Cell Profile");
        ...
        StringRequest reqgetCellDetails=new StringRequest(Request.Method.POST, SynergyValues.Web.GetCellDetailsService.SERVICE_URL,new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Log.d("NonStop", "Sr Cell Name: " + jarray.getJSONObject(0).getString("senior_cell_name"));
                    Log.d("NonStop", "Sr Cell Leader: " + jarray.getJSONObject(0).getString("senior_cell_leader"));
                    ...
                    if(jarray.getJSONObject(0).getString("senior_cell_name") != null)
                        txtCellName.setText(jarray.getJSONObject(0).getString("senior_cell_name"));

                    if(jarray.getJSONObject(0).getString("senior_cell_leader") != null)
                        txtCellLeader.setText(jarray.getJSONObject(0).getString("senior_cell_leader"));
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if(error.networkResponse.statusCode==403){
                    Methods.longToast("Access Denied", ShortBioSrCell.this);
                }
                else
                    Methods.longToast("Some Error Occured,please try again later", ShortBioSrCell.this);
