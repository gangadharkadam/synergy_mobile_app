...
public class CreateGroupChurchMasterFormActivity extends ActionBarActivity implements OnClickListener{
    ...
    private ArrayList<String> mZoneList,mRegionList,mSrCellList;
    private PreferenceHelper mPreferenceHelper;
    private Gson gson;
    String zone= null,church= null,churchGroup= null,pcf= null,region= null,senior_cell = null;
    private Spinner spnSeniorCellZone,spnSeniorCellRegion;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_group_church_master_form);
        initialize();
    }
    ...
    public boolean isValid() {
        ...
        if(!InputValidation.hasText(txtSeniorCellName)) {
            AlertDialog dialog = new AlertDialog.Builder(CreateGroupChurchMasterFormActivity.this)
                    .setCancelable(false)
    ...
    private void initialize() {
        ...
        txtSeniorCellName=(EditText) findViewById(R.id.txtGroupChurchName);
        ...
        lblzone.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(NetworkHelper.isOnline(CreateGroupChurchMasterFormActivity.this)){

                    String selval=spnSeniorCellRegion.getSelectedItem().toString();

                    Methods.showProgressDialog(CreateGroupChurchMasterFormActivity.this);
                    getSpinnerData("Regions",selval );

                }else
                {
                    Methods.longToast("Please connect to Internet",CreateGroupChurchMasterFormActivity.this);
                }
                ...
                try {
                    ...
                    if(response.contains("status")){
                        ...
                        if(status.equals("401"))
                            Methods.longToast("User name or Password is incorrect", CreateGroupChurchMasterFormActivity.this);
                    ...
                    else
                    {
                        ...
                        if(jsonarray.length()>0) {
                            ...
                            if (tbl.equalsIgnoreCase("Regions")) {
                                ...
                                ArrayAdapter<String> adapterZone = new ArrayAdapter<String>(CreateGroupChurchMasterFormActivity.this, android.R.layout.simple_spinner_item, mZoneList);
...
//				Log.e(null, "111--"+spnSeniorCell.getSelectedItemPosition());
                ...
                try {
                    ...
                    if(response.contains("status")){
                        ...
                        if(jsonarray.length()>0){
                            ...
                            Methods.longToast("Record Not Found ", CreateGroupChurchMasterFormActivity.this);
    ...
    private void setAdapters() {
        ...
        ArrayAdapter<String> adapterRegion = new ArrayAdapter<String>(CreateGroupChurchMasterFormActivity.this, android.R.layout.simple_spinner_item, mRegionList);
    ...
    private boolean validateFields() {
        ...
        if(txtSeniorCellName.getText().toString().trim().length() >0)
        {
            ...
            Methods.longToast("Please enter Group Church Name", this);
        }
		/*}else
		{
    ...
    protected void saveCellMaster() {
        StringRequest reqsaveCellMaster=new StringRequest(Method.POST, SynergyValues.Web.CreateGroupChurchService.SERVICE_URL,new Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(response.contains("status"))
                {
                    ...
                    if(null !=model.getMessage().getMessage() && model.getMessage().getMessage().trim().length() >0){
                        Methods.longToast(model.getMessage().getMessage(), CreateGroupChurchMasterFormActivity.this);
                    }
                }else{
                    ...
                    if(null !=model.getMessage() && model.getMessage().trim().length() >0){
                        Methods.longToast(model.getMessage(), CreateGroupChurchMasterFormActivity.this);
                    }
                    finish();
               /*    Intent intForm=new Intent(CreateGroupChurchMasterFormActivity.this,DisplayMastersListActivity.class);
                    intForm.putExtra("OptionSelected", "Group Churches");
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Methods.longToast("Some Error Occured,please try again later", CreateGroupChurchMasterFormActivity.this);
            }
        })
        {
            @Override
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                srCellModel.setChurch_group(txtSeniorCellName.getText().toString().trim());
                ...
                params.put(SynergyValues.Web.CreateGroupChurchService.DATA, dataString);
